...
-########++-----.--+----..--+#-....-+#++++++---+-+++++++++++++++++++++++-#++##.##+#+###-#-+##+-##-#--+#--#######++######+++#####+##+++++++++++++++++++++++#++++.
  ...
  print('\n')
  texto = ('Obrigado por testar o jogo.\n')
  escrita_rpg(texto)
...
escrita_rpg(texto)
texto = ('Agradeço pelos ensinamentos do professor João Coelho que estão sendo passados na turma B da Universidade de Vassouras de Saquarema.\n')
escrita_rpg(texto)
texto = ('Pois nunca tive contato com nenhuma linguagem de programação antes, estou aprendendo bastante com as aulas do professor e também por fora com vídeos da internet.\n')
escrita_rpg(texto)
texto = (f'Obrigado por testar o jogo {personagem}, até a próxima ^.^\n\n\n')
escrita_rpg(texto)
print('='*182)
time.sleep(5)
texto = ('''
