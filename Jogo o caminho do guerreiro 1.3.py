...
escrita_rpg(texto)
texto = (f'Um(a) destemido(a) aventureiro(a) chamado(a) {personagem}, foi convocado(a) por um antigo oráculo para recuperar as partes da Pedra Elemental da Harmonia\ne impedir que Sephiroth usasse seu poder para subjugar o mundo.\n')
escrita_rpg(texto)
print('\n')
print('='*182)
time.sleep(2)
...
\n''')
  ...
  escrita_rpg(texto)
  texto = ('e não conseguiu encontrar o fragmento da água da Pedra Elemental da Hamornia.\n\n' )
  escrita_rpg(texto)
  texto = ('\nFim de jogo.\n\n')
  escrita_rpg(texto)
  sys.exit()
