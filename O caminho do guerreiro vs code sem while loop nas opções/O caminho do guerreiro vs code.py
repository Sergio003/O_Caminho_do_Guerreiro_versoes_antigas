...
# Jogo Produzido por Sérgio, primeiro período turma B Universidade de Vassouras Saquarema Novembro de 2023.
...
# Volte no VS CODE e execute o jogo, caso dê erro no pygame outra vez, aperte o atalho no seu teclado ctrl+shift+p no VS CODE.
...
-########++-----.--+----..--+#-....-+#++++++---+-+++++++++++++++++++++++-#++##.##+#+###-#-+##+-##-#--+#--#######++######+++#####+##+++++++++++++++++++++++#++++.
  ...
  print('\n')
  texto = ('Obrigado por testar meu jogo.\n')
  escrita_rpg(texto)
...
escrita_rpg(texto)
texto = ('Devido ao pouco tempo entre trabalho e faculdade, consegui concluir apenas 3 capítulos da história.\n')
escrita_rpg(texto)
texto = ('Para os próximos capítulos tenho muitas idéias, como a implementação de um sistema de combate melhorado.\n')
escrita_rpg(texto)
...
escrita_rpg(texto)
texto = ('Agradeço pelos ensinamentos do professor João Coelho que estão sendo ministrados na turma B da Universidade de Vassouras de Saquarema.\n')
escrita_rpg(texto)
texto = ('Pois nunca tive contato com nenhuma linguagem de programação antes, estou aprendendo bastante com as aulas de python do professor e também por fora com vídeos da internet.\n')
escrita_rpg(texto)
texto = (f'Obrigado por testar meu jogo {personagem}, até a próxima ^.^\n\n\n')
escrita_rpg(texto)
print('='*182)
time.sleep(2)
texto = ('''
