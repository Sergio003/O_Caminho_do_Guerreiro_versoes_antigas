...
'''
  ...
  print('\n')
  texto = ('Obrigado por testar o jogar.\n\n')
  escrita_rpg(texto)
...
escrita_rpg(texto)
texto = (f'Após uma breve caminhada, {personagem} ficou sabendo que o fragmento elemental da água está entre as ruas 96 e 13 do Reino de Jaconé.')
escrita_rpg(texto)
...
escrita_rpg(texto)
texto = f'Depois de uma breve galopada, {personagem} pegou a avenida litorânea e passou pelo Reino de Barra Nova para descansar.\n'
escrita_rpg(texto)
texto = f'No dia seguinte, depois do café da manhã, {personagem} continuou sua jornada até chegar ao Reino de Boqueirão.\n'
escrita_rpg(texto)
texto = f'No Reino de Boqueirão, {personagem} sentiu um forte tremor de terra, e avistou uma montanha gigantesca surgindo no epicentro do tremor.\n'
escrita_rpg(texto)
texto = f'{personagem} logo deduziu que somente um guardião elemental teria poder suficiente para fazer isso.\n'
escrita_rpg(texto)
texto = f'{personagem} deixou seu amigo e fiél escudeiro pé de pano em um local seguro, e foi sozinho escalar a montanha.\n'
escrita_rpg(texto)
texto =f'No topo da montanha, {personagem} ficou frente a frente com o guardião elemental da terra, prepare-se para a batalha!\n'
escrita_rpg(texto)
texto =f'O guardião elemental da terra iniciou o ataque, lançando várias pedras cortantes pontiagudas em sua direção.\n\n\n'
escrita_rpg(texto)
print('='*182)
print('\n')
texto = ('O que você vai fazer?\n\n')
escrita_rpg(texto)
texto = ('[1] Tentar desviar do ataque?\n')
escrita_rpg(texto)
texto = ('[2] Defender o ataque com seu escudo?\n\n')
escrita_rpg(texto)
escolha = input('Digite 1 ou 2: ')
print('\n')
print('='*182)
